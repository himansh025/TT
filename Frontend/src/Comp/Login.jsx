...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await axiosInstance.post(`/api/teachers/login/`, data);
  ...
  return (
    <div className="min-h-screen flex items-center  bg-gradient-to-br from-blue-50 to-indigo-100 justify-center  p-4">
      <div className="w-full max-w-6xl overflow-hidden rounded-2xl shadow-2xl bg-white">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="hidden md:block md:w-1/2 relative bg-indigo-600">
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-600/80 to-blue-800/80 z-10"></div>
            <img 
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-white z-20 p-8">
              <h2 className="text-4xl font-bold mb-6">Welcome Teachers</h2>
              <p className="text-xl text-center max-w-md opacity-90">
                Access your classroom resources, schedules.
              </p>
